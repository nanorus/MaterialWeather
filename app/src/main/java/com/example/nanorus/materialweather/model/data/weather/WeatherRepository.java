package com.example.nanorus.materialweather.model.data.weather;
...
public class WeatherRepository {
    ...
    public Single<CurrentDayWeatherPojo> getNowWeatherOnline(String place) {
        return getNowWeatherRequestOnline(place)
                .map(CurrentDayWeatherPojo::map);
    }
...
/*    public Observable<FiveDaysListPojo> loadFullWeatherThreeHoursOnline(String place) {
    ...
    public void saveNowWeatherData(CurrentDayWeatherPojo currentTimeWeatherPojo) {
        mAppPreferencesManager.setNowWeatherData(currentTimeWeatherPojo);
    }

    public Single<CurrentDayWeatherPojo> loadNowWeatherData() {
